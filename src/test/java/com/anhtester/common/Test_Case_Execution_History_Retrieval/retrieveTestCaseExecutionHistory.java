...
public class retrieveTestCaseExecutionHistory {

    private WebDriver driver;
    private String className = "retrieveTestCaseExecutionHistory";
    private String subid = "HS-119";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseExecutionHistory(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseExecutionHistory test = new retrieveTestCaseExecutionHistory(driver);
        test.runTest();
    }
}
