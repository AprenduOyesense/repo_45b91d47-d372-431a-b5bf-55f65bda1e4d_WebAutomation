...
public class createNewTestCase {
    ...
    private String className = "createNewTestCase";
    private String subid = "HS-135";

    // Constructor to initialize WebDriver and set className and subid
    public createNewTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        createNewTestCase test = new createNewTestCase(driver);
        test.runTest();
    }
}
