...
public class authenticateWithValidCredentials {

    private WebDriver driver;
    private String className = "authenticateWithValidCredentials";
    private String subid = "HS-129";

    // Constructor to initialize WebDriver and set className and subid
    public authenticateWithValidCredentials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authenticateWithValidCredentials test = new authenticateWithValidCredentials(driver);
        test.runTest();
    }
}
