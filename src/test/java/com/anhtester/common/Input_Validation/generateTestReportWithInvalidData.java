...
public class generateTestReportWithInvalidData {

    private WebDriver driver;
    private String className = "generateTestReportWithInvalidData";
    private String subid = "HS-143";

    // Constructor to initialize WebDriver and set className and subid
    public generateTestReportWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        generateTestReportWithInvalidData test = new generateTestReportWithInvalidData(driver);
        test.runTest();
    }
}
