...
public class updateProjectDetailsWithInvalidData {

    private WebDriver driver;
    private String className = "updateProjectDetailsWithInvalidData";
    private String subid = "HS-147";

    // Constructor to initialize WebDriver and set className and subid
    public updateProjectDetailsWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateProjectDetailsWithInvalidData test = new updateProjectDetailsWithInvalidData(driver);
        test.runTest();
    }
}
