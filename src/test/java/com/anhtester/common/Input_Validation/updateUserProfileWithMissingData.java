...
public class updateUserProfileWithMissingData {

    private WebDriver driver;
    private String className = "updateUserProfileWithMissingData";
    private String subid = "HS-149";

    // Constructor to initialize WebDriver and set className and subid
    public updateUserProfileWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateUserProfileWithMissingData test = new updateUserProfileWithMissingData(driver);
        test.runTest();
    }
}
