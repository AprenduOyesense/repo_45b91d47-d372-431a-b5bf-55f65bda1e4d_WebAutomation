...
public class updateActualResultWithMissingData {

    private WebDriver driver;
    private String className = "updateActualResultWithMissingData";
    private String subid = "HS-162";

    // Constructor to initialize WebDriver and set className and subid
    public updateActualResultWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateActualResultWithMissingData test = new updateActualResultWithMissingData(driver);
        test.runTest();
    }
}
