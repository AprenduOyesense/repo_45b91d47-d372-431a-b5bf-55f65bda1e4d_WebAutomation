...
public class createProjectWithInvalidData {

    private WebDriver driver;
    private String className = "createProjectWithInvalidData";
    private String subid = "HS-148";

    // Constructor to initialize WebDriver and set className and subid
    public createProjectWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        createProjectWithInvalidData test = new createProjectWithInvalidData(driver);
        test.runTest();
    }
}
