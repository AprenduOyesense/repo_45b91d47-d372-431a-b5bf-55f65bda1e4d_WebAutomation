...
public class updateTestCaseStatusWithMissingData {

    private WebDriver driver;
    private String className = "updateTestCaseStatusWithMissingData";
    private String subid = "HS-160";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseStatusWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseStatusWithMissingData test = new updateTestCaseStatusWithMissingData(driver);
        test.runTest();
    }
}
