...
public class updateTestRunDetailsWithInvalidData {

    private WebDriver driver;
    private String className = "updateTestRunDetailsWithInvalidData";
    private String subid = "HS-145";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestRunDetailsWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestRunDetailsWithInvalidData test = new updateTestRunDetailsWithInvalidData(driver);
        test.runTest();
    }
}
