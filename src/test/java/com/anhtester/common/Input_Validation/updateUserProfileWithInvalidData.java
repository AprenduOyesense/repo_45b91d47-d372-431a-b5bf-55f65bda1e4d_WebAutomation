...
public class updateUserProfileWithInvalidData {

    private WebDriver driver;
    private String className = "updateUserProfileWithInvalidData";
    private String subid = "HS-150";

    // Constructor to initialize WebDriver and set className and subid
    public updateUserProfileWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateUserProfileWithInvalidData test = new updateUserProfileWithInvalidData(driver);
        test.runTest();
    }
}
