...
public class updateTestCaseExpectedResultWithMissingData {

    private WebDriver driver;
    private String className = "updateTestCaseExpectedResultWithMissingData";
    private String subid = "HS-156";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseExpectedResultWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseExpectedResultWithMissingData test = new updateTestCaseExpectedResultWithMissingData(driver);
        test.runTest();
    }
}
