...
public class addTestCaseToTestRunWithInvalidData {

    private WebDriver driver;
    private String className = "addTestCaseToTestRunWithInvalidData";
    private String subid = "HS-153";

    // Constructor to initialize WebDriver and set className and subid
    public addTestCaseToTestRunWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        addTestCaseToTestRunWithInvalidData test = new addTestCaseToTestRunWithInvalidData(driver);
        test.runTest();
    }
}
