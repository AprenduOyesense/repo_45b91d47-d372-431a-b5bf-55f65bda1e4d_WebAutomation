...
public class createTestRunWithInvalidData {

    private WebDriver driver;
    private String className = "createTestRunWithInvalidData";
    private String subid = "HS-154";

    // Constructor to initialize WebDriver and set className and subid
    public createTestRunWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        createTestRunWithInvalidData test = new createTestRunWithInvalidData(driver);
        test.runTest();
    }
}
