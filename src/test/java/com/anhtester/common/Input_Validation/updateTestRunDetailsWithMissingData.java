...
public class updateTestRunDetailsWithMissingData {

    private WebDriver driver;
    private String className = "updateTestRunDetailsWithMissingData";
    private String subid = "HS-144";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestRunDetailsWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestRunDetailsWithMissingData test = new updateTestRunDetailsWithMissingData(driver);
        test.runTest();
    }
}
