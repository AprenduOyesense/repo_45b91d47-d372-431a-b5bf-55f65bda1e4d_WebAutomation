...
public class updateTestCaseDescriptionWithMissingData {

    private WebDriver driver;
    private String className = "updateTestCaseDescriptionWithMissingData";
    private String subid = "HS-158";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseDescriptionWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseDescriptionWithMissingData test = new updateTestCaseDescriptionWithMissingData(driver);
        test.runTest();
    }
}
