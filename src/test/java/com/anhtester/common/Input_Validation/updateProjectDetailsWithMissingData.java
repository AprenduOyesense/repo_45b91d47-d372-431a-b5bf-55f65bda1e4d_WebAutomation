...
public class updateProjectDetailsWithMissingData {

    private WebDriver driver;
    private String className = "updateProjectDetailsWithMissingData";
    private String subid = "HS-146";

    // Constructor to initialize WebDriver and set className and subid
    public updateProjectDetailsWithMissingData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateProjectDetailsWithMissingData test = new updateProjectDetailsWithMissingData(driver);
        test.runTest();
    }
}
