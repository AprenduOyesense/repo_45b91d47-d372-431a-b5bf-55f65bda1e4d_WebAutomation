...
public class authenticateWithMissingCredentials {

    private WebDriver driver;
    private String className = "authenticateWithMissingCredentials";
    private String subid = "HS-151";

    // Constructor to initialize WebDriver and set className and subid
    public authenticateWithMissingCredentials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authenticateWithMissingCredentials test = new authenticateWithMissingCredentials(driver);
        test.runTest();
    }
}
