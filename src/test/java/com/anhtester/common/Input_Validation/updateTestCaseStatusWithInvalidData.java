...
public class updateTestCaseStatusWithInvalidData {

    private WebDriver driver;
    private String className = "updateTestCaseStatusWithInvalidData";
    private String subid = "HS-161";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseStatusWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseStatusWithInvalidData test = new updateTestCaseStatusWithInvalidData(driver);
        test.runTest();
    }
}
