...
public class createTestCaseWithInvalidData {

    private WebDriver driver;
    private String className = "createTestCaseWithInvalidData";
    private String subid = "HS-155";

    // Constructor to initialize WebDriver and set className and subid
    public createTestCaseWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        createTestCaseWithInvalidData test = new createTestCaseWithInvalidData(driver);
        test.runTest();
    }
}
