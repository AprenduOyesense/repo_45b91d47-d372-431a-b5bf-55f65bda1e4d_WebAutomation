...
public class removeTestCaseFromTestRunWithInvalidData {

    private WebDriver driver;
    private String className = "removeTestCaseFromTestRunWithInvalidData";
    private String subid = "HS-152";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseFromTestRunWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseFromTestRunWithInvalidData test = new removeTestCaseFromTestRunWithInvalidData(driver);
        test.runTest();
    }
}
