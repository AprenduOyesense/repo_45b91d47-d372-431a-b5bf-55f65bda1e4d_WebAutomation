...
public class updateActualResultWithInvalidData {

    private WebDriver driver;
    private String className = "updateActualResultWithInvalidData";
    private String subid = "HS-163";

    // Constructor to initialize WebDriver and set className and subid
    public updateActualResultWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateActualResultWithInvalidData test = new updateActualResultWithInvalidData(driver);
        test.runTest();
    }
}
