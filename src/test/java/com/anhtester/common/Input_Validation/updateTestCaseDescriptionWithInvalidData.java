...
public class updateTestCaseDescriptionWithInvalidData {

    private WebDriver driver;
    private String className = "updateTestCaseDescriptionWithInvalidData";
    private String subid = "HS-159";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseDescriptionWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseDescriptionWithInvalidData test = new updateTestCaseDescriptionWithInvalidData(driver);
        test.runTest();
    }
}
