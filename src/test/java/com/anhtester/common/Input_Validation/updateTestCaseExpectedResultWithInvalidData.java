...
public class updateTestCaseExpectedResultWithInvalidData {

    private WebDriver driver;
    private String className = "updateTestCaseExpectedResultWithInvalidData";
    private String subid = "HS-157";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseExpectedResultWithInvalidData(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseExpectedResultWithInvalidData test = new updateTestCaseExpectedResultWithInvalidData(driver);
        test.runTest();
    }
}
