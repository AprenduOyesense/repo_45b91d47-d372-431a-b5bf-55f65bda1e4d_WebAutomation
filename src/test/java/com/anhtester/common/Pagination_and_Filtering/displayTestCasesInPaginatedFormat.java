...
public class displayTestCasesInPaginatedFormat {

    private WebDriver driver;
    private String className = "displayTestCasesInPaginatedFormat";
    private String subid = "HS-185";

    // Constructor to initialize WebDriver and set className and subid
    public displayTestCasesInPaginatedFormat(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        displayTestCasesInPaginatedFormat test = new displayTestCasesInPaginatedFormat(driver);
        test.runTest();
    }
}
