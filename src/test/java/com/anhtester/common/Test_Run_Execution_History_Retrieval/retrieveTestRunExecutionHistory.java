...
public class retrieveTestRunExecutionHistory {

    private WebDriver driver;
    private String className = "retrieveTestRunExecutionHistory";
    private String subid = "HS-116";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunExecutionHistory(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunExecutionHistory test = new retrieveTestRunExecutionHistory(driver);
        test.runTest();
    }
}
