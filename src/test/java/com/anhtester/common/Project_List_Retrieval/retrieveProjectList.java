...
public class retrieveProjectList {

    private WebDriver driver;
    private String className = "retrieveProjectList";
    private String subid = "HS-124";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveProjectList(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveProjectList test = new retrieveProjectList(driver);
        test.runTest();
    }
}
