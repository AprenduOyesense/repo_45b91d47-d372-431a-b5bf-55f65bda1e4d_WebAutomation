...
public class retrieveProgressOfTestCases {

    private WebDriver driver;
    private String className = "retrieveProgressOfTestCases";
    private String subid = "HS-142";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveProgressOfTestCases(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveProgressOfTestCases test = new retrieveProgressOfTestCases(driver);
        test.runTest();
    }
}
