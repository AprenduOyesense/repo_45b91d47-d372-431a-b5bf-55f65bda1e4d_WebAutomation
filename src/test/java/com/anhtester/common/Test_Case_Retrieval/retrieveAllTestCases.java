...
public class retrieveAllTestCases {
    ...
    private String className = "retrieveAllTestCases";
    private String subid = "HS-186";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveAllTestCases(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveAllTestCases test = new retrieveAllTestCases(driver);
        test.runTest();
    }
}
