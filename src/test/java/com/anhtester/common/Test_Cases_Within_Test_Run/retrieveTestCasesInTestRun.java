...
public class retrieveTestCasesInTestRun {

    private WebDriver driver;
    private String className = "retrieveTestCasesInTestRun";
    private String subid = "HS-140";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCasesInTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCasesInTestRun test = new retrieveTestCasesInTestRun(driver);
        test.runTest();
    }
}
