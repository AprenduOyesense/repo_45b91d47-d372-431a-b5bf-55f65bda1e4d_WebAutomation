...
public class retrieveTestRunDetails {

    private WebDriver driver;
    private String className = "retrieveTestRunDetails";
    private String subid = "HS-113";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunDetails test = new retrieveTestRunDetails(driver);
        test.runTest();
    }
}
