...
public class updateProjectDetails {
    ...
    private String className = "updateProjectDetails";
    private String subid = "HS-121";

    // Constructor to initialize WebDriver and set className and subid
    public updateProjectDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateProjectDetails test = new updateProjectDetails(driver);
        test.runTest();
    }
}
