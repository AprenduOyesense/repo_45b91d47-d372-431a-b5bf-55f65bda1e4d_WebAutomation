...
public class updateTestCaseDescription {
    ...
    private String className = "updateTestCaseDescription";
    private String subid = "HS-137";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseDescription(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseDescription test = new updateTestCaseDescription(driver);
        test.runTest();
    }
}
