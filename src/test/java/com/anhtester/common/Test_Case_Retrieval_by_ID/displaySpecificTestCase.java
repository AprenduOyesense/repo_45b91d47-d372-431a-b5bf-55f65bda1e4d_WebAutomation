...
public class displaySpecificTestCase {

    private WebDriver driver;
    private String className = "displaySpecificTestCase";
    private String subid = "HS-165";

    // Constructor to initialize WebDriver and set className and subid
    public displaySpecificTestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        displaySpecificTestCase test = new displaySpecificTestCase(driver);
        test.runTest();
    }
}
