...
public class updateTestCaseExpectedResult {
    ...
    private String className = "updateTestCaseExpectedResult";
    private String subid = "HS-136";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseExpectedResult(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseExpectedResult test = new updateTestCaseExpectedResult(driver);
        test.runTest();
    }
}
