...
public class retrieveSpecificProject {

    private WebDriver driver;
    private String className = "retrieveSpecificProject";
    private String subid = "HS-123";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveSpecificProject(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveSpecificProject test = new retrieveSpecificProject(driver);
        test.runTest();
    }
}
