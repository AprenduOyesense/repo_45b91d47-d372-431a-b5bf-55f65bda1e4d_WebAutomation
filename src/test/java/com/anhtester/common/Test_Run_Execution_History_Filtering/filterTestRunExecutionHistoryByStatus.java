...
public class filterTestRunExecutionHistoryByStatus {

    private WebDriver driver;
    private String className = "filterTestRunExecutionHistoryByStatus";
    private String subid = "HS-114";

    // Constructor to initialize WebDriver and set className and subid
    public filterTestRunExecutionHistoryByStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        filterTestRunExecutionHistoryByStatus test = new filterTestRunExecutionHistoryByStatus(driver);
        test.runTest();
    }
}
