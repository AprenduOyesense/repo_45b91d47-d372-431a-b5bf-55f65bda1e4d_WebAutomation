...
public class filterTestRunExecutionHistoryByDate {

    private WebDriver driver;
    private String className = "filterTestRunExecutionHistoryByDate";
    private String subid = "HS-115";

    // Constructor to initialize WebDriver and set className and subid
    public filterTestRunExecutionHistoryByDate(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        filterTestRunExecutionHistoryByDate test = new filterTestRunExecutionHistoryByDate(driver);
        test.runTest();
    }
}
