...
public class retrieveAllTestRuns {

    private WebDriver driver;
    private String className = "retrieveAllTestRuns";
    private String subid = "HS-141";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveAllTestRuns(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveAllTestRuns test = new retrieveAllTestRuns(driver);
        test.runTest();
    }
}
