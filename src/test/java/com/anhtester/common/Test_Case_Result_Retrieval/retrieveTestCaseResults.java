...
public class retrieveTestCaseResults {

    private WebDriver driver;
    private String className = "retrieveTestCaseResults";
    private String subid = "HS-111";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseResults(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseResults test = new retrieveTestCaseResults(driver);
        test.runTest();
    }
}
