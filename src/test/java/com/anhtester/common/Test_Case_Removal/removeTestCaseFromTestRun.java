...
public class removeTestCaseFromTestRun {

    private WebDriver driver;
    private String className = "removeTestCaseFromTestRun";
    private String subid = "HS-130";

    // Constructor to initialize WebDriver and set className and subid
    public removeTestCaseFromTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        removeTestCaseFromTestRun test = new removeTestCaseFromTestRun(driver);
        test.runTest();
    }
}
