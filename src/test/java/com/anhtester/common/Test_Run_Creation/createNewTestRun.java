...
public class createNewTestRun {
    ...
    private String className = "createNewTestRun";
    private String subid = "HS-133";

    // Constructor to initialize WebDriver and set className and subid
    public createNewTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        createNewTestRun test = new createNewTestRun(driver);
        test.runTest();
    }
}
