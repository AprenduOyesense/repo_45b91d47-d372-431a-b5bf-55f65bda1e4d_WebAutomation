...
public class retrieveTestCaseDetails {

    private WebDriver driver;
    private String className = "retrieveTestCaseDetails";
    private String subid = "HS-138";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseDetails test = new retrieveTestCaseDetails(driver);
        test.runTest();
    }
}
