...
public class retrieveUserProfile {
    ...
    private String className = "retrieveUserProfile";
    private String subid = "HS-127";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveUserProfile(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveUserProfile test = new retrieveUserProfile(driver);
        test.runTest();
    }
}
