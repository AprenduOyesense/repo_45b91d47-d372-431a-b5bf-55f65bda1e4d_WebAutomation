...
public class filterTestCaseExecutionHistoryByStatus {

    private WebDriver driver;
    private String className = "filterTestCaseExecutionHistoryByStatus";
    private String subid = "HS-117";

    // Constructor to initialize WebDriver and set className and subid
    public filterTestCaseExecutionHistoryByStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        filterTestCaseExecutionHistoryByStatus test = new filterTestCaseExecutionHistoryByStatus(driver);
        test.runTest();
    }
}
