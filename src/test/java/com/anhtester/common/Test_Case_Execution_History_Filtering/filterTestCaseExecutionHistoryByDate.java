...
public class filterTestCaseExecutionHistoryByDate {

    private WebDriver driver;
    private String className = "filterTestCaseExecutionHistoryByDate";
    private String subid = "HS-118";

    // Constructor to initialize WebDriver and set className and subid
    public filterTestCaseExecutionHistoryByDate(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        filterTestCaseExecutionHistoryByDate test = new filterTestCaseExecutionHistoryByDate(driver);
        test.runTest();
    }
}
