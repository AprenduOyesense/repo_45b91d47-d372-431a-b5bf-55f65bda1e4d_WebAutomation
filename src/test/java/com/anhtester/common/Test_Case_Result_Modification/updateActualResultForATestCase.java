...
public class updateActualResultForATestCase {

    private WebDriver driver;
    private String className = "updateActualResultForATestCase";
    private String subid = "HS-164";

    // Constructor to initialize WebDriver and set className and subid
    public updateActualResultForATestCase(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateActualResultForATestCase test = new updateActualResultForATestCase(driver);
        test.runTest();
    }
}
