...
public class deleteProjectWithInvalidID {

    private WebDriver driver;
    private String className = "deleteProjectWithInvalidID";
    private String subid = "HS-171";

    // Constructor to initialize WebDriver and set className and subid
    public deleteProjectWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        deleteProjectWithInvalidID test = new deleteProjectWithInvalidID(driver);
        test.runTest();
    }
}
