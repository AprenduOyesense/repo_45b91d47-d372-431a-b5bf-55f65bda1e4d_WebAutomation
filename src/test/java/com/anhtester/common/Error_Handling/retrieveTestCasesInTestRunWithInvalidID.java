...
public class retrieveTestCasesInTestRunWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestCasesInTestRunWithInvalidID";
    private String subid = "HS-182";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCasesInTestRunWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCasesInTestRunWithInvalidID test = new retrieveTestCasesInTestRunWithInvalidID(driver);
        test.runTest();
    }
}
