...
public class retrieveTestCaseExecutionHistoryWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestCaseExecutionHistoryWithInvalidID";
    private String subid = "HS-170";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseExecutionHistoryWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseExecutionHistoryWithInvalidID test = new retrieveTestCaseExecutionHistoryWithInvalidID(driver);
        test.runTest();
    }
}
