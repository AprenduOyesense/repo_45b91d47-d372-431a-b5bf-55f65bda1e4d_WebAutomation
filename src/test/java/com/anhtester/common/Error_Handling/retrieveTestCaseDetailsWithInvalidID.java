...
public class retrieveTestCaseDetailsWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestCaseDetailsWithInvalidID";
    private String subid = "HS-181";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseDetailsWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseDetailsWithInvalidID test = new retrieveTestCaseDetailsWithInvalidID(driver);
        test.runTest();
    }
}
