...
public class retrieveTestRunResultsWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestRunResultsWithInvalidID";
    private String subid = "HS-166";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunResultsWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunResultsWithInvalidID test = new retrieveTestRunResultsWithInvalidID(driver);
        test.runTest();
    }
}
