...
public class authorizeAccessWithInvalidToken {

    private WebDriver driver;
    private String className = "authorizeAccessWithInvalidToken";
    private String subid = "HS-177";

    // Constructor to initialize WebDriver and set className and subid
    public authorizeAccessWithInvalidToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authorizeAccessWithInvalidToken test = new authorizeAccessWithInvalidToken(driver);
        test.runTest();
    }
}
