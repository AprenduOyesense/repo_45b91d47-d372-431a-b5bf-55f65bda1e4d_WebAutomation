...
public class retrieveProgressWithInvalidProjectID {

    private WebDriver driver;
    private String className = "retrieveProgressWithInvalidProjectID";
    private String subid = "HS-184";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveProgressWithInvalidProjectID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveProgressWithInvalidProjectID test = new retrieveProgressWithInvalidProjectID(driver);
        test.runTest();
    }
}
