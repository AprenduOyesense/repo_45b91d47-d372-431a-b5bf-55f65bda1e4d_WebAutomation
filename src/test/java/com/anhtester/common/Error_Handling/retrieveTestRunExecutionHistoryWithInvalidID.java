...
public class retrieveTestRunExecutionHistoryWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestRunExecutionHistoryWithInvalidID";
    private String subid = "HS-169";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunExecutionHistoryWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunExecutionHistoryWithInvalidID test = new retrieveTestRunExecutionHistoryWithInvalidID(driver);
        test.runTest();
    }
}
