...
public class retrieveUserProfileWithInvalidToken {

    private WebDriver driver;
    private String className = "retrieveUserProfileWithInvalidToken";
    private String subid = "HS-175";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveUserProfileWithInvalidToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveUserProfileWithInvalidToken test = new retrieveUserProfileWithInvalidToken(driver);
        test.runTest();
    }
}
