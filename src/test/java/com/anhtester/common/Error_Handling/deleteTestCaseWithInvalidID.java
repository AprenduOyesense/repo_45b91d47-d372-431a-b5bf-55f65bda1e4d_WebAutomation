...
public class deleteTestCaseWithInvalidID {

    private WebDriver driver;
    private String className = "deleteTestCaseWithInvalidID";
    private String subid = "HS-180";

    // Constructor to initialize WebDriver and set className and subid
    public deleteTestCaseWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        deleteTestCaseWithInvalidID test = new deleteTestCaseWithInvalidID(driver);
        test.runTest();
    }
}
