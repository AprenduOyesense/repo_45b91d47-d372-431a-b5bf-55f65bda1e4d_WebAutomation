...
public class authorizeAccessWithExpiredToken {

    private WebDriver driver;
    private String className = "authorizeAccessWithExpiredToken";
    private String subid = "HS-176";

    // Constructor to initialize WebDriver and set className and subid
    public authorizeAccessWithExpiredToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authorizeAccessWithExpiredToken test = new authorizeAccessWithExpiredToken(driver);
        test.runTest();
    }
}
