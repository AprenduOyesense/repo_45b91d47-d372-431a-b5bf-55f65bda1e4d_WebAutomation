...
public class authenticateWithInvalidCredentials {

    private WebDriver driver;
    private String className = "authenticateWithInvalidCredentials";
    private String subid = "HS-178";

    // Constructor to initialize WebDriver and set className and subid
    public authenticateWithInvalidCredentials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authenticateWithInvalidCredentials test = new authenticateWithInvalidCredentials(driver);
        test.runTest();
    }
}
