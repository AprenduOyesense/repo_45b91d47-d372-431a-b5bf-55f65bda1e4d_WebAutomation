...
public class deleteTestRunWithInvalidID {

    private WebDriver driver;
    private String className = "deleteTestRunWithInvalidID";
    private String subid = "HS-179";

    // Constructor to initialize WebDriver and set className and subid
    public deleteTestRunWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        deleteTestRunWithInvalidID test = new deleteTestRunWithInvalidID(driver);
        test.runTest();
    }
}
