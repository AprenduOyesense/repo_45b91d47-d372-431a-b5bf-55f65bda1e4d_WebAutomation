...
public class deleteUserAccountWithInvalidToken {

    private WebDriver driver;
    private String className = "deleteUserAccountWithInvalidToken";
    private String subid = "HS-174";

    // Constructor to initialize WebDriver and set className and subid
    public deleteUserAccountWithInvalidToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        deleteUserAccountWithInvalidToken test = new deleteUserAccountWithInvalidToken(driver);
        test.runTest();
    }
}
