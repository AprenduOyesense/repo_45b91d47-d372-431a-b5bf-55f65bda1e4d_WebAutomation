...
public class retrieveTestRunsWithInvalidProjectID {

    private WebDriver driver;
    private String className = "retrieveTestRunsWithInvalidProjectID";
    private String subid = "HS-183";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunsWithInvalidProjectID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunsWithInvalidProjectID test = new retrieveTestRunsWithInvalidProjectID(driver);
        test.runTest();
    }
}
