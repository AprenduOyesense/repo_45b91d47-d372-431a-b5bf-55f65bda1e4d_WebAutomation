...
public class retrieveTestCaseResultsWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestCaseResultsWithInvalidID";
    private String subid = "HS-167";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestCaseResultsWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestCaseResultsWithInvalidID test = new retrieveTestCaseResultsWithInvalidID(driver);
        test.runTest();
    }
}
