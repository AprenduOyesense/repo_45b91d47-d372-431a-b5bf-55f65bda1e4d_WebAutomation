...
public class retrieveSpecificProjectWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveSpecificProjectWithInvalidID";
    private String subid = "HS-172";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveSpecificProjectWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveSpecificProjectWithInvalidID test = new retrieveSpecificProjectWithInvalidID(driver);
        test.runTest();
    }
}
