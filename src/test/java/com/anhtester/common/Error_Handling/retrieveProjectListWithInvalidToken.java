...
public class retrieveProjectListWithInvalidToken {

    private WebDriver driver;
    private String className = "retrieveProjectListWithInvalidToken";
    private String subid = "HS-173";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveProjectListWithInvalidToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveProjectListWithInvalidToken test = new retrieveProjectListWithInvalidToken(driver);
        test.runTest();
    }
}
