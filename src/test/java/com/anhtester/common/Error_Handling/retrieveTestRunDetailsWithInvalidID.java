...
public class retrieveTestRunDetailsWithInvalidID {

    private WebDriver driver;
    private String className = "retrieveTestRunDetailsWithInvalidID";
    private String subid = "HS-168";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunDetailsWithInvalidID(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunDetailsWithInvalidID test = new retrieveTestRunDetailsWithInvalidID(driver);
        test.runTest();
    }
}
