...
public class addTestCaseToTestRun {

    private WebDriver driver;
    private String className = "addTestCaseToTestRun";
    private String subid = "HS-131";

    // Constructor to initialize WebDriver and set className and subid
    public addTestCaseToTestRun(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        addTestCaseToTestRun test = new addTestCaseToTestRun(driver);
        test.runTest();
    }
}
