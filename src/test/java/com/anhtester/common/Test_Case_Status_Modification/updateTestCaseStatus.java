...
public class updateTestCaseStatus {
    ...
    private String className = "updateTestCaseStatus";
    private String subid = "HS-139";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestCaseStatus(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestCaseStatus test = new updateTestCaseStatus(driver);
        test.runTest();
    }
}
