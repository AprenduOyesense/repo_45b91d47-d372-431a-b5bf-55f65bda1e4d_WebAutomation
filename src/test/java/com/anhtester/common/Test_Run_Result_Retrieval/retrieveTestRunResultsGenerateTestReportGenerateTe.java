...
public class retrieveTestRunResultsGenerateTestReportGenerateTe {

    private WebDriver driver;
    private String className = "retrieveTestRunResultsGenerateTestReportGenerateTe";
    private String subid = "HS10";

    // Constructor to initialize WebDriver and set className and subid
    public retrieveTestRunResultsGenerateTestReportGenerateTe(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        retrieveTestRunResultsGenerateTestReportGenerateTe test = new retrieveTestRunResultsGenerateTestReportGenerateTe(driver);
        test.runTest();
    }
}
