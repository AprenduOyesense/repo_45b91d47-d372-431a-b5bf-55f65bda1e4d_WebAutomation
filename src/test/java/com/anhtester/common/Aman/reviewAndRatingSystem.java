...
public class reviewAndRatingSystem {
    ...
    private String className = "reviewAndRatingSystem";
    private String subid = "HS-103";

    // Constructor to initialize WebDriver and set className and subid
    public reviewAndRatingSystem(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        reviewAndRatingSystem test = new reviewAndRatingSystem(driver);
        test.runTest();
    }
}
