...
public class contactCustomerSupport {
    ...
    private String className = "contactCustomerSupport";
    private String subid = "HS-101";

    // Constructor to initialize WebDriver and set className and subid
    public contactCustomerSupport(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        contactCustomerSupport test = new contactCustomerSupport(driver);
        test.runTest();
    }
}
