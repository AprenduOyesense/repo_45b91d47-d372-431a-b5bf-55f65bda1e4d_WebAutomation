...
public class customerTestimonials {
    ...
    private String className = "customerTestimonials";
    private String subid = "HS-102";

    // Constructor to initialize WebDriver and set className and subid
    public customerTestimonials(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        customerTestimonials test = new customerTestimonials(driver);
        test.runTest();
    }
}
