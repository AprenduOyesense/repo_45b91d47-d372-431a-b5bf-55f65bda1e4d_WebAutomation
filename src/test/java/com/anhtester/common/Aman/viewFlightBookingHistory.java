...
public class viewFlightBookingHistory {

    private WebDriver driver;
    private String className = "viewFlightBookingHistory";
    private String subid = "HS-104";

    // Constructor to initialize WebDriver and set className and subid
    public viewFlightBookingHistory(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewFlightBookingHistory test = new viewFlightBookingHistory(driver);
        test.runTest();
    }
}
