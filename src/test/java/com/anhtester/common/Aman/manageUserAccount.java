...
public class manageUserAccount {
    ...
    private String className = "manageUserAccount";
    private String subid = "HS-105";

    // Constructor to initialize WebDriver and set className and subid
    public manageUserAccount(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        manageUserAccount test = new manageUserAccount(driver);
        test.runTest();
    }
}
