...
public class cancelFlightBooking {

    private WebDriver driver;
    private String className = "cancelFlightBooking";
    private String subid = "HS-106";

    // Constructor to initialize WebDriver and set className and subid
    public cancelFlightBooking(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        cancelFlightBooking test = new cancelFlightBooking(driver);
        test.runTest();
    }
}
