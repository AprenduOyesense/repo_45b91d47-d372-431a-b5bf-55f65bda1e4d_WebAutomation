...
public class aMAANANANANA {

    private WebDriver driver;
    private String className = "aMAANANANANA";
    private String subid = "HS01";

    // Constructor to initialize WebDriver and set className and subid
    public aMAANANANANA(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        aMAANANANANA test = new aMAANANANANA(driver);
        test.runTest();
    }
}
