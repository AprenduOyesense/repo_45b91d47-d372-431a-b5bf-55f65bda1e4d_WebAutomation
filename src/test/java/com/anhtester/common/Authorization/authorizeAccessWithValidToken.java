...
public class authorizeAccessWithValidToken {

    private WebDriver driver;
    private String className = "authorizeAccessWithValidToken";
    private String subid = "HS-128";

    // Constructor to initialize WebDriver and set className and subid
    public authorizeAccessWithValidToken(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        authorizeAccessWithValidToken test = new authorizeAccessWithValidToken(driver);
        test.runTest();
    }
}
