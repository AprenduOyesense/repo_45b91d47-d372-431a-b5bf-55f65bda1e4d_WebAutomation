...
public class updateTestRunDetails {

    private WebDriver driver;
    private String className = "updateTestRunDetails";
    private String subid = "HS-112";

    // Constructor to initialize WebDriver and set className and subid
    public updateTestRunDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        updateTestRunDetails test = new updateTestRunDetails(driver);
        test.runTest();
    }
}
