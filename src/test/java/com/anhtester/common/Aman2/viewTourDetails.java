...
public class viewTourDetails {

    private WebDriver driver;
    private String className = "viewTourDetails";
    private String subid = "HS-100";

    // Constructor to initialize WebDriver and set className and subid
    public viewTourDetails(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public static void main(String[] args) {
        ...
        viewTourDetails test = new viewTourDetails(driver);
        test.runTest();
    }
}
